 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://service.sushchanka.company.com/", wsdlLocation = "http://localhost:8080/module17?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://service.sushchanka.company.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/module17?wsdl");
    ...
    public UserServiceImpl getUserServiceImplPort() {
        return super.getPort(new QName("http://service.sushchanka.company.com/", "UserServiceImplPort"), UserServiceImpl.class);
    }
    ...
    public UserServiceImpl getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.sushchanka.company.com/", "UserServiceImplPort"), UserServiceImpl.class, features);
    }
