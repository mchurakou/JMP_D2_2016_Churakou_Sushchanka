...
<html>
	<head>
		...
		<link href="webResources/css/resolutionAddPage.css" rel="stylesheet"   type="text/css" />
	</head>
	<body>
		<div class="content">
		 <span class="text"><spring:message code="label.enterNewResol"/></span>
		<form method="POST" action = "<c:url value='/ResolutionAddingController'/>">
