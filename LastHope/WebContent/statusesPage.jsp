...
<head>
	...
	<link href="webResources/css/statusesPage.css" rel="stylesheet"   type="text/css" />
...
<body>
	<div class="content">
		<table>
			<tr>
				...
				<c:forEach items = "${statusList}" var = "status" varStatus = "newStatus" >
					<tr>
						<td><a  href="JavaScript:addName('${status.name}','${status.id}')" >${status.name}</a></td>
	 ...
	 <form  name="name" method="POST"  action="<c:url value= '/PrepareDataForEditStatusesController'/>" > 
