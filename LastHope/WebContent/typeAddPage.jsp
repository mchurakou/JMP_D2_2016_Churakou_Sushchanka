...
<html>
	<head>
		...
		<link href="webResources/css/typeAddPage.css" rel="stylesheet"   type="text/css" />
	</head>
	<body>
		<div class="content">
		 <span class="text"><spring:message code="label.enterNewType"/></span>
		<form method="POST" action = "<c:url value='/TypeAddingController'/>">
