...
@XmlRootElement(name = "findTaskByNameResponse", namespace = "http://service.sushchanka.company.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findTaskByNameResponse", namespace = "http://service.sushchanka.company.com/")
